...
describe("OAuth provider configuration", () => {
  it.each(["google", "apple"] as const)("exchanges and verifies a signed %s fixture", async (provider) => {
    ...
    const payload = encode({
      ...
      aud: "client", sub: "person", email: "person@gmail.com",
    ...
    const client = createOauthProviderClient(provider, {
      ...
      apple: { clientId: "client", callbackUri: "https://api.example/apple", keyId: "key", teamId: "team",
