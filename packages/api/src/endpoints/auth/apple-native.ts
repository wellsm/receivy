...
declare class StartRequest implements Http.Request { body: { clientChallenge: String.Max<43> } }
declare class ExchangeRequest implements Http.Request { body: { state: String.Max<128>; authorizationCode: String.Max<2048>; codeVerifier: String.Max<128>; profile?: String.Max<1024>; deviceName?: String.Max<120> } }
declare class StartResponse implements Http.Response { status: 200; body: { state: string; nonce: string } }
declare class ExchangeResponse implements Http.Response { status: 200; body: AuthSessionResponse }
...
export async function nativeAppleExchangeHandler(request: ExchangeRequest, context: Service.Context<ApiProvider>): Promise<ExchangeResponse> {
