...
declare class CreateResponse implements Http.Response { status: 201; body: Person }
declare class UpdateResponse implements Http.Response { status: 200; body: Person }
declare class ArchiveResponse implements Http.Response { status: 204 }

function parse(input: PersonInput): PersonInput {
  try { return normalizePerson(input); } catch (error) {
