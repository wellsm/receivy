...
export declare class ProofCleanupScheduler extends Cron.Service {
  ...
  variables: {
    ...
    PROOF_STORAGE_MODE: Environment.VariableOrValue<
      "PROOF_STORAGE_MODE",
      "disabled"
    >;
    PROOF_S3_BUCKET: Environment.VariableOrValue<"PROOF_S3_BUCKET", "disabled">;
    PROOF_LOCAL_DIRECTORY: Environment.VariableOrValue<
      "PROOF_LOCAL_DIRECTORY",
      "disabled"
    >;
    PROOF_LOCAL_BASE_URL: Environment.VariableOrValue<
      "PROOF_LOCAL_BASE_URL",
      "disabled"
    >;
    PROOF_LOCAL_SECRET: Environment.VariableOrValue<
      "PROOF_LOCAL_SECRET",
      "disabled"
    >;
  };
