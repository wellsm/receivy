...
export type ChargeRoutes = [
  ...
  Http.UseRoute<{ name: "cancelCharge"; path: "POST /charges/{id}/cancel"; authorizer: typeof sessionAuthorizer; handler: typeof cancelChargeHandler }>,
  Http.UseRoute<{ name: "manualPayment"; path: "POST /charges/{id}/payments"; authorizer: typeof sessionAuthorizer; handler: typeof manualPaymentHandler }>,
];
