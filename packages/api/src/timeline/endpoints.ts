...
declare class TimelineRequest implements Http.Request { identity: SessionIdentity; query: {
  cursor?: String.Max<500>; direction?: "receivable" | "payable"; status?: "pending" | "paid" | "cancelled" | "overdue";
  source?: "expense" | "recurrence"; from?: String.Date; to?: String.Date;
} }
declare class LedgerRequest implements Http.Request { identity: SessionIdentity; parameters: { id: String.UUID }; query: { cursor?: String.UUID } }
declare class TimelineResponse implements Http.Response { status: 200; body: TimelinePage }
declare class LedgerResponse implements Http.Response { status: 200; body: PersonLedger }
