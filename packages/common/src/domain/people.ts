...
export function normalizePerson(input: PersonInput): PersonInput {
  if (typeof input?.name !== "string" || (input.email !== undefined && typeof input.email !== "string") ||
      (input.phone !== undefined && typeof input.phone !== "string")) throw new Error("Dados de contato inválidos.");
