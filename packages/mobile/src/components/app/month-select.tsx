    ...
    <View>
      ...
      {open && (
        <Modal transparent animationType="slide" visible onRequestClose={() => setOpen(false)}>
          <Pressable accessibilityRole="button" accessibilityLabel="Fechar meses" onPress={() => setOpen(false)} className="flex-1 bg-scrim" />
              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    {active && <Image source={checkMark} tintColor={colors.primaryStrong} style={{ width: 16, height: 16 }} />}
                  </Pressable>
                );
              })}
            </ScrollView>
