    ...
    <SafeAreaView className="flex-1 bg-canvas" edges={["top"]}>
      <View className="flex-row items-center justify-between px-5 pb-2 pt-3">
        <View className="flex-row items-center gap-2">
          ...
          <Text className="text-xl font-extrabold text-primary-strong">Receivy</Text>
        </View>
        <Pressable
          accessibilityRole="button"
        ...
        >
          <Image source={bellMark} tintColor={ACTIVE_TINT} style={{ width: 20, height: 20 }} />
          {summary && summary.proofsToReview > 0 && <View className="absolute right-2 top-2 h-2 w-2 rounded-full bg-red-600" />}
        </Pressable>
      </View>
