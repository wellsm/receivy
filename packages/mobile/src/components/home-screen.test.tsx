...
describe("HomeScreen", () => {
  ...
  const item = (id: string, description: string, state: "pending" | "paid" | "cancelled", installment = 1) => ({ kind: "charge" as const, direction: "payable" as const, charge: { id, description, amount: { amountCents: 100, currency: "BRL" as const }, dueDate: "2026-09-10", state, source: "expense" as const, installment, installmentCount: 3 } });
