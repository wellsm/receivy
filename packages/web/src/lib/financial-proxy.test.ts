...
describe("financial BFF allowlist", () => {
  it.each([
    ...
    ["POST", "charges/charge-id/public-link"], ["POST", "charges/charge-id/public-link/rotate"],
  ...
  it.each([
    ["GET", "timeline"], ["GET", "billings/id/preview"], ["DELETE", "charges/charge-id/public-link"], ["DELETE", "charges/id"], ["GET", "auth/me"], ["GET", "../auth/me"],
